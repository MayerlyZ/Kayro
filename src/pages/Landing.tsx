...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background">
        ...
        <div className="max-w-6xl mx-auto text-center">
          <div className="mb-8">
            <h1 className="text-4xl md:text-6xl font-bold text-foreground mb-4">
              Bienvenido a <span className="text-primary"  style={{ color: "#0cf25d" }}  >Kayro</span>
            </h1>
            ...
            <Button
              ...
              style={{ backgroundColor: "#0cf25d", color: "#fff"}}
            > 
              Comenzar Gratis
            </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto" >
            <Card>
              <CardContent className="p-6 text-center">
                <Target className="h-12 w-12 text-primary mx-auto mb-4" style={{ color: "#0cf25d" }} />
            ...
            <Card>
              <CardContent className="p-6 text-center">
                <Users className="h-12 w-12 text-primary mx-auto mb-4"  style={{ color: "#0cf25d" }}  />
            ...
            <Card>
              <CardContent className="p-6 text-center">
                <Star className="h-12 w-12 text-primary mx-auto mb-4"  style={{ color: "#0cf25d" }} />
      ...
      <section className="py-20 px-4 bg-muted/30">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              <CardHeader>
                <Dumbbell className="h-10 w-10 text-primary mb-4"  style={{ color: "#0cf25d" }}  />
            ...
            <Card>
              <CardHeader>
                <Target className="h-10 w-10 text-primary mb-4"  style={{ color: "#0cf25d" }}  />
            ...
            <Card>
              <CardHeader>
                <TrendingUp className="h-10 w-10 text-primary mb-4"  style={{ color: "#0cf25d" }} />
            ...
            <Card>
              <CardHeader>
                <Users className="h-10 w-10 text-primary mb-4"  style={{ color: "#0cf25d" }}  />
            ...
            <Card>
              <CardHeader>
                <CheckCircle className="h-10 w-10 text-primary mb-4"  style={{ color: "#0cf25d" }}  />
            ...
            <Card>
              <CardHeader>
                <Star className="h-10 w-10 text-primary mb-4"  style={{ color: "#0cf25d" }} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card>
              <CardHeader>
                ...
                <div className="text-3xl font-bold text-foreground mt-4">
                  $0<span className="text-lg text-muted-foreground"  style={{ color: "#0fab46" }}>/mes</span>
                </div>
              </CardHeader>
              <CardContent>
                ...
                <Button className="w-full mt-6" variant="outline" style={{ background: "#0fab46", color:"#ffff", marginTop:"40px"}}> 
                  Comenzar Gratis
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="border-primary">
              <CardHeader>
                ...
                <div className="text-3xl font-bold text-foreground mt-4">
                  $89.900<span className="text-lg text-muted-foreground" style={{ color: "#0fab46" }}>/mes</span>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3" >
                ...
                <Button className="w-full mt-6" style={{ backgroundColor: "#0fab46" }}>
                  Obtener Premium
                </Button>
              </CardContent>
            </Card>
      ...
      {/* CTA Section */}
      <section className="py-20 px-4 bg-primary text-primary-foreground"  style={{ backgroundColor: "#0fab46" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            ¿Listo para comenzar tu transformación?
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Únete a miles de usuarios que ya están alcanzando sus objetivos con Kayro
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="text-lg px-8 border-primary-foreground text-primary-foreground hover:bg-primary-foreground hover:text-primary color"
              style={{ color: "#093d34" }}
