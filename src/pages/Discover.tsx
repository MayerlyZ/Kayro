                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Link to={`/trainer/${trainer.id}`}>
                      <Button className="w-full border-0 text-white hover:shadow-glow hover:opacity-90 transition-all duration-300" style={{background: '(135deg, #02735E )'}}>
                        Ver Entrenador
                      </Button>
                    </Link>
                  </div>
